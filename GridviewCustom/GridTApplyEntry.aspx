<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="GridTApplyEntry.aspx.cs" Inherits="kurihara_GridviewCustom_GridTApplyEntry" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
	<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="F_ID,F_VERSION,F_TITLE,F_BEGIN_DATE,F_END_DATE,F_COMMENT,F_IS_INVASION,F_INVASION_TYPE,F_INVASION_SEVERE_TEXT,F_IS_MONEY_TRANSFER,F_MONEY_TRANSFER_TYPE,F_CREATE_USER_ID,F_UPDATE_USER_ID,F_CREATE_DATE,F_UPDATE_DATE" DataSourceID="T_APPLY_ENTRY">
		<Columns>
			<asp:TemplateField>
				<HeaderTemplate>
					ボタン
				...
				<ItemTemplate>
					<div>
						<asp:Button ID="SELECT" Text="詳細" runat="server" OnClick="SELECT_Click" />
					</div>
				</ItemTemplate>
			</asp:TemplateField>
