<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="GridTUser.aspx.cs" Inherits="kurihara_GridviewCustom_GridTUser" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
	<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="F_ID,F_LAST_NAME,F_FIRST_NAME,F_LAST_NAME_KANA,F_FIRST_NAME_KANA,F_EMAIL,F_PASS,F_CREATE_USER_ID,F_UPDATE_USER_ID,F_CREATE_DATE,F_UPDATE_DATE" DataSourceID="T_USER">
		<Columns>
			<asp:TemplateField>
				<HeaderTemplate>
					ボタン
	...
	<asp:SqlDataSource ID="T_USER" runat="server" ConnectionString="<%$ ConnectionStrings:MyConnectionStr %>" SelectCommand="SELECT * FROM [T_USER]"></asp:SqlDataSource>
	<br />
	<hr />
	F_ID:
