<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WebUserControlTUser.ascx.cs" Inherits="kurihara_UserControlSample_WebUserControlTUser" %>
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="F_ID" DataSourceID="T_USER" OnRowCommand="GridView1_RowCommand">
	<Columns>
