<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WebUserControlTApplyModify.ascx.cs" Inherits="kurihara_UserControlSample_WebUserControlTApplyModify" %>
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="F_ID,F_VERSION" DataSourceID="T_APPLY_MODIFY" OnRowCommand="GridView1_RowCommand">
	<Columns>
