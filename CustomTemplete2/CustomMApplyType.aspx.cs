...
public partial class kurihara_CustomTemplete2_CustomMApplyType : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                this.M_APPLY_TYPE.DataKeyNames = new string[2] { "BIND_F_ID","BIND_F_NAME"};
    ...
    protected void Select_Click(object sender, EventArgs e)
    {
        ...
        var f_id = M_APPLY_TYPE.DataKeys[row.RowIndex].Values["BIND_F_ID"].ToString();
        var f_name = M_APPLY_TYPE.DataKeys[row.RowIndex].Values["BIND_F_NAME"].ToString();
