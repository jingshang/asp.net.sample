...
public partial class kurihara_CustomTemplete3_Custom3M_APPLY_TYPE : System.Web.UI.Page
{
    ...
    protected void UPDATE_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            try
            {
                command.CommandText = @"update M_APPLY_TYPE set  F_NAME=@F_NAME where F_ID=@id";
