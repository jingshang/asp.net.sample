<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="M_MONEY_TRANSFER_TYPE.aspx.cs" Inherits="kurihara_CustomTemplete3_M_MONEY_TRANSFER_TYPE" %>
	...
	<div>
		<asp:GridView ID="M_MONEY_TRANSFER_TYPE" runat="server" AutoGenerateColumns="false" >
			<Columns>
				<asp:TemplateField>
					<ItemTemplate>
						<asp:Button ID="SELETC" runat="server" Text="PUSH" OnClick="SELETC_Click" />
					</ItemTemplate>
				</asp:TemplateField>
				<asp:TemplateField>
					<HeaderTemplate>
