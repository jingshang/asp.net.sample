<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="S_SYSTEM_SETTING.aspx.cs" Inherits="kurihara_CustomTemplete3_S_SYSTEM_SETTING" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
	...
	<div>
		<table>
			...
			<tr>
				<th>SETTING1</th>
				<td><asp:TextBox ID="SETTING1" runat="server" Text=""></asp:TextBox></td>
			</tr>
			<tr>
				<th>SETTING2</th>
				<td><asp:TextBox ID="SETTING2" runat="server" Text=""></asp:TextBox></td>
			</tr>
			<tr>
				<th>更新</th>
