<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WebUserControlT_APPLY_ENTRY.ascx.cs" Inherits="kurihara_UserControl2_WebUserControlT_APPLY_ENTRY" %>
<div>
	<asp:GridView ID="T_APPLY_ENTRY" runat="server" AutoGenerateColumns="false" OnRowCommand="T_APPLY_ENTRY_RowCommand">
		<Columns>
			<asp:TemplateField>
				<ItemTemplate>
