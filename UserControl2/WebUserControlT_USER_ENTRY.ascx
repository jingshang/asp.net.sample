<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WebUserControlT_USER_ENTRY.ascx.cs" Inherits="kurihara_UserControl2_WebUserControlT_USER_ENTRY" %>
<div>
	<asp:GridView ID="T_USER_ENTRY" runat="server" AutoGenerateColumns="false" OnRowCommand="T_USER_ENTRY_RowCommand">
		<Columns>
				<asp:TemplateField>
					<ItemTemplate>
