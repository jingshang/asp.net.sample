<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="NomalControl.aspx.cs" Inherits="YourName_NomalControl" %>
...
for( var i = 0; i < text_count; i++){
	...
	<div class="group_div">
		...
		<asp:Image ID="Image_RadioButton41" runat="server" ImageUrl="~/YourName/SampleProject/SampleProjectDoc/RadioButton4.jpg" />
		しかし、ラジオボタンを選択するたびにロードされたら見にくいですね。<br />
		そこでUpdatePanelというもので囲うとその部分の描画だけ更新されます。<br />
		非同期でサーバーとやり取りする基本的な仕組みです。<br />
		<asp:Image ID="Image_RadioButton5" runat="server" ImageUrl="~/YourName/SampleProject/SampleProjectDoc/RadioButton5.jpg" />
		<br />
