<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="GridView.aspx.cs" Inherits="kurihara_GridView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
	...
	<div class="group_div">
		...
		<p>
			...
			GridView の表示内容をTプログラムから用意する方法です。<br />
		...
		<asp:GridView ID="GridView_Sample1" runat="server" AutoGenerateColumns="false">
			<Columns>
				...
				<asp:ImageField NullImageUrl="~/kurihara/SampleProject/SampleProjectDoc/GridView1.jpg" DataImageUrlField="SAMPLE_URL"></asp:ImageField>
